...
fn make_primary_bg(
    ...
    payload_in: &wgpu::TextureView,
    payload_out: &wgpu::TextureView,
    ...
    device.create_bind_group(&wgpu::BindGroupDescriptor {
        ...
        entries: &[
            ...
            wgpu::BindGroupEntry {
                binding: 15,
                resource: wgpu::BindingResource::TextureView(payload_in),
            },
            wgpu::BindGroupEntry {
                binding: 16,
                resource: wgpu::BindingResource::TextureView(payload_out),
            },
            wgpu::BindGroupEntry {
                binding: 17,
...
pub fn create_bind_groups(
    ...
    let primary = [
        make_primary_bg(
            ...
            &textures.primary_hit_payload[0].view,
            &textures.primary_hit_payload[1].view,
