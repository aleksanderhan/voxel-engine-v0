...
fn make_composite_bg(
    ...
    local_sampler: &wgpu::Sampler,
    output_hist_in_view: &wgpu::TextureView,
    output_hist_sampler: &wgpu::Sampler,
    output_hist_out_view: &wgpu::TextureView,
    label: &str,
) -> wgpu::BindGroup {
    device.create_bind_group(&wgpu::BindGroupDescriptor {
        label: Some(label),
        ...
        entries: &[
            ...
            wgpu::BindGroupEntry { binding: 7, resource: wgpu::BindingResource::TextureView(output_hist_in_view) },
            wgpu::BindGroupEntry { binding: 8, resource: wgpu::BindingResource::Sampler(output_hist_sampler) },
            wgpu::BindGroupEntry { binding: 9, resource: wgpu::BindingResource::TextureView(output_hist_out_view) },
        ],
    })
}
