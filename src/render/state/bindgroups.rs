...
fn make_primary_bg(
    ...
    hist_extra_in: &wgpu::Buffer,
    hist_extra_out: &wgpu::Buffer,
    ...
    device.create_bind_group(&wgpu::BindGroupDescriptor {
        ...
        entries: &[
            ...
            wgpu::BindGroupEntry {
                binding: 17,
                resource: hist_extra_in.as_entire_binding(),
            },
            wgpu::BindGroupEntry {
                binding: 18,
                resource: hist_extra_out.as_entire_binding(),
            },
        ],
    })
}
...
pub fn create_bind_groups(
    ...
    let primary = [
        make_primary_bg(
            ...
            &textures.primary_hit_hist_extra[0],
            &textures.primary_hit_hist_extra[1],
