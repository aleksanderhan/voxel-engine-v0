...
fn make_primary_bg(
    ...
    payload_in: &wgpu::Buffer,
    payload_out: &wgpu::Buffer,
    ...
    device.create_bind_group(&wgpu::BindGroupDescriptor {
        ...
        entries: &[
            ...
            wgpu::BindGroupEntry {
                binding: 15,
                resource: payload_in.as_entire_binding(),
            },
            wgpu::BindGroupEntry {
                binding: 16,
                resource: payload_out.as_entire_binding(),
            },
            wgpu::BindGroupEntry {
                binding: 17,
...
pub fn create_bind_groups(
    ...
    let primary = [
        make_primary_bg(
            ...
            &textures.primary_hit_payload[0],
            &textures.primary_hit_payload[1],
